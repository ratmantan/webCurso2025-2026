...
Original file is located at
    https://colab.research.google.com/drive/1QO9uWDygSRyzqexDbyIcOYqIUi2P4OyU
...
def collect_subclasses(graph, cls):
    subs = set()
    stack = [cls]
    while stack:
        current = stack.pop()
...
person_subclasses = collect_subclasses(g, ns.Person)

types_to_check = set(person_subclasses)
types_to_check.add(ns.Person)
