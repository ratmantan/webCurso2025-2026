...
Original file is located at
    https://colab.research.google.com/drive/1o4vAXUX5RMBjg_zYo7ruo2Fb9edhT7iJ
...
g.add((raul, RDF.type, ontology.AssociateProfessor))
...
# Relationships (according to diagram)
...
g.add((asun, ontology.hasHomePage, Literal("www.asun.com", datatype=XSD.string)))
...
g.add((oscar, VCARD.Family, Literal("Martinez", datatype=XSD.string)))
